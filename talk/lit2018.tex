...
\begin{frame}{Was andere denken}
 ...
 \vspace{\baselineskip}
	\small{populärste Programmiersprachen auf Github 2017} \footnotesize{(\url{octoverse.github.com})}
...
\begin{frame}{nbgrader}
 \begin{columns}
  ...
  \begin{column}{0.3\textwidth}
   \begin{center}
    \vspace{-0.7truecm}
    \includegraphics[width=0.8\textwidth]{hamrick}
